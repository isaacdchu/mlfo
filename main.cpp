...
int main() {
    ...
    inputs.emplace_back(std::make_unique<Tensor>(std::vector<std::size_t>{2, 3}, 0, 1.0f));
    inputs.emplace_back(std::make_unique<Tensor>(std::vector<std::size_t>{2, 3}, 0, 2.0f));
